      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
            I am Kartikey Pandey, a passionate Full Stack Developer specializing in building scalable and user-friendly web applications. With expertise in the MERN stack, modern frontend technologies, and backend optimization, I craft seamless digital experiences. My focus is on delivering high-quality solutions through clean code, responsive design, and efficient problem-solving. I thrive on innovation and continuous learning to stay ahead in the ever-evolving tech landscape.
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/1 ">
                  ...
                  Developed a Project Management System inspired by JIRA, including features like Kanban boards, calendar
